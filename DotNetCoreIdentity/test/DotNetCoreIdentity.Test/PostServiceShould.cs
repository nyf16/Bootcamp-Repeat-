...
namespace DotNetCoreIdentity.Test
{
    public class PostServiceShould
    {
        ...
        // Verileri kayit ederken db ayarlarinin ayni dbName icerisinde olduguna dikkat edin, eger dbName'ler farkliysa test verileri farkli veri tabanlarina kayit edilir. Tüm test metodlarinda[Fact] lerde ayri dbName'ler verilmesinin sebebi budur.
